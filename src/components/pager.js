...
export default function Pager({ currentPage: page, numPages: pageCount, pages = [], nextPage, prevPage }) {
	const pageRange = pageCount <= MAX_PAGES_SHOWN ? range(0, pageCount) : computeRangeWindow(MAX_PAGES_SHOWN, page, pageCount);
